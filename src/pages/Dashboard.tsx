            ...
            {activeTab === "today" ? (
              loadingData ? (
                ...
                <div className="p-1 sm:p-2 md:p-3 lg:p-4 space-y-1 sm:space-y-2 md:space-y-3 max-w-[1600px] mx-auto w-full">
                  ...
                  <div 
                    ref={headerRef}
                    className={`${isHeaderSticky ? "sticky top-0" : "relative"} z-40 bg-background/95 backdrop-blur-md py-3 -mx-1 sm:-mx-2 md:-mx-3 lg:-mx-4 px-1 sm:px-2 md:px-3 lg:px-4 border-b border-border/40 shadow-sm space-y-3 transition-all duration-300`}
                  >
                    <LtpBanner 
