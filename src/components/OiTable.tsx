            ...
            <TableBody>
              {data.map((row) => (
                <TableRow key={row.strikePrice} className="border-border hover:bg-muted/40 transition-colors">
                  ...
                  <TableCell className="text-center font-bold text-primary bg-primary/10 border-x border-primary/20 px-1 sm:px-2 py-1.5 sm:py-2.5 text-xs sm:text-sm">{row.strikePrice}</TableCell>
                  ...
                  <TableCell className="text-center text-blue-400 font-semibold px-1 sm:px-2 py-1.5 sm:py-2.5 text-xs sm:text-sm">{formatDecimal(row.imbalance)}</TableCell>
                  <TableCell className="text-center text-purple-400 font-semibold px-1 sm:px-2 py-1.5 sm:py-2.5 text-xs sm:text-sm">{formatDecimal(row.pcr, 4)}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
