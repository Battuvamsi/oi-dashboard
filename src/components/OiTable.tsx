          ...
          <Table className="text-[9px] sm:text-[10px] md:text-xs lg:text-base w-full">
            <TableHeader>
              <TableRow className="border-border bg-muted/30">
                <TableHead colSpan={4} className="text-center font-bold text-green-400 bg-green-500/20 px-0.5 sm:px-1 md:px-2 lg:px-3 py-1 sm:py-1.5 md:py-2 lg:py-2.5 text-[9px] sm:text-[10px] md:text-xs lg:text-sm border-r border-border">
                  CALLS
                </TableHead>
                ...
                <TableHead colSpan={4} className="text-center font-bold text-red-400 bg-red-500/20 px-0.5 sm:px-1 md:px-2 lg:px-3 py-1 sm:py-1.5 md:py-2 lg:py-2.5 text-[9px] sm:text-[10px] md:text-xs lg:text-sm border-r border-border">
                  PUTS
                </TableHead>
                <TableHead colSpan={3} className="text-center font-bold text-blue-400 bg-blue-500/20 px-0.5 sm:px-1 md:px-2 lg:px-3 py-1 sm:py-1.5 md:py-2 lg:py-2.5 text-[9px] sm:text-[10px] md:text-xs lg:text-sm">
                  FINAL DATA
                </TableHead>
              </TableRow>
              <TableRow className="border-border hover:bg-muted/50 bg-muted/20">
                <TableHead className="text-center font-bold text-green-400 bg-green-500/10 px-0.5 sm:px-1 md:px-1.5 lg:px-2 py-0.5 sm:py-1 md:py-1.5 lg:py-2 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs">COI</TableHead>
                <TableHead className="text-center font-bold text-green-400 bg-green-500/10 px-0.5 sm:px-1 md:px-1.5 lg:px-2 py-0.5 sm:py-1 md:py-1.5 lg:py-2 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs">OI</TableHead>
                <TableHead className="text-center font-bold text-green-400 bg-green-500/10 px-0.5 sm:px-1 md:px-1.5 lg:px-2 py-0.5 sm:py-1 md:py-1.5 lg:py-2 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs">ΔOI</TableHead>
                <TableHead className="text-center font-bold text-green-400 bg-green-500/10 px-0.5 sm:px-1 md:px-1.5 lg:px-2 py-0.5 sm:py-1 md:py-1.5 lg:py-2 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs">LTP</TableHead>
                ...
                <TableHead className="text-center font-bold text-red-400 bg-red-500/10 px-0.5 sm:px-1 md:px-1.5 lg:px-2 py-0.5 sm:py-1 md:py-1.5 lg:py-2 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs">LTP</TableHead>
                <TableHead className="text-center font-bold text-red-400 bg-red-500/10 px-0.5 sm:px-1 md:px-1.5 lg:px-2 py-0.5 sm:py-1 md:py-1.5 lg:py-2 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs">ΔOI</TableHead>
                <TableHead className="text-center font-bold text-red-400 bg-red-500/10 px-0.5 sm:px-1 md:px-1.5 lg:px-2 py-0.5 sm:py-1 md:py-1.5 lg:py-2 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs">OI</TableHead>
                <TableHead className="text-center font-bold text-red-400 bg-red-500/10 px-0.5 sm:px-1 md:px-1.5 lg:px-2 py-0.5 sm:py-1 md:py-1.5 lg:py-2 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs">COI</TableHead>
                <TableHead className="text-center font-bold text-blue-400 bg-blue-500/10 px-0.5 sm:px-1 md:px-1.5 lg:px-2 py-0.5 sm:py-1 md:py-1.5 lg:py-2 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs">IMB</TableHead>
                <TableHead className="text-center font-bold text-purple-400 bg-purple-500/10 px-0.5 sm:px-1 md:px-1.5 lg:px-2 py-0.5 sm:py-1 md:py-1.5 lg:py-2 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs">PCR</TableHead>
                <TableHead className="text-center font-bold text-cyan-400 bg-cyan-500/10 px-0.5 sm:px-1 md:px-1.5 lg:px-2 py-0.5 sm:py-1 md:py-1.5 lg:py-2 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs">TREND</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {data.map((row) => (
